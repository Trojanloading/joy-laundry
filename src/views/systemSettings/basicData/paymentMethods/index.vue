<template>
  ...
  <div class="paymentMethods-container">
    <div class="btn">
      <el-button type="primary" round @click.native.stop="addPaymentMethods">添加付款方式</el-button>
    </div>
    <el-table
      :data="pageList"
      height="310px"
    ...
    >
      <el-table-column prop="type" label="付款方式"></el-table-column>
...
import deletePaymentMethods from "./deletePaymentMethods";
  ...
  methods: {
    ...
    handleCurrentChange1: function(currentPage) {
      ...
      setTimeout(() => {
        ...
        this.currentChangePage(this.paymentMethods, currentPage);
      }, 300);
    },
      ...
      axios
        ...
        .then(res => {
          if (res.data == false) {
            setTimeout(() => {
              this.paymentMethods = "";
              this.currentChangePage(this.paymentMethods, this.currentPage1);
              this.loadingTbDate = false;
            }, 1000);
            console.log("查找失败");
          } else {
