<template>
  <!-- 衣服品牌设置 -->
  <div class="clothingBrand-container">
    <div class="btn">
      <el-button type="primary" round @click.native.stop="addClothingBrand">添加衣服品牌</el-button>
    </div>
    <el-table
      :data="pageList"
      height="310px"
    ...
    >
      <el-table-column prop="type" label="衣服品牌"></el-table-column>
...
<script>
import addClothingBrand from "./addClothingBrand";
import editClothingBrand from "./editClothingBrand";
import deleteClothingBrand from "./deleteClothingBrand";
  ...
  methods: {
    ...
    handleCurrentChange1: function(currentPage) {
      ...
      setTimeout(() => {
        ...
        this.currentChangePage(this.clothingBrand, currentPage);
      }, 300);
    },
      ...
      axios
        ...
        .then(res => {
          if (res.data == false) {
            setTimeout(() => {
              this.clothingBrand = "";
              this.currentChangePage(this.clothingBrand, this.currentPage1);
              this.loadingTbDate = false;
            }, 1000);
            console.log("查找失败");
          } else {
            setTimeout(() => {
              this.clothingBrand = res.data;
              this.currentChangePage(this.clothingBrand, this.currentPage1);
              this.loadingTbDate = false;
            }, 1000);
          }
