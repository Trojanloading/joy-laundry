<template>
  ...
  <div class="deleteOrder-container">
    <el-dialog title="删除该订单记录" top="30vh" :visible.sync="dialogFormVisible">
      <div class="title">此操作将永久删除该订单记录, 是否继续?</div>
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          round
          :loading="loading"
          @click.native.prevent="handleDelOrder"
        >{{ btnText }}</el-button>
      </div>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    handleDelOrder() {
      ...
      axios
        .post(
          "http://127.0.0.1:3000/collectionClothings/laundryManagement/delOrder",
