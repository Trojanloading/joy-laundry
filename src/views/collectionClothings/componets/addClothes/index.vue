<template>
  <!-- 添加衣物 -->
  <div class="addClothes-container">
    <el-form ref="addClothesForm" :model="addClothesForm" :rules="addClothesRules">
      <div class="arrangement">
        ...
        <el-form-item>
          <label>是否付费:</label>
          <el-switch v-model="addClothesForm.ispaid" active-value="是" inactive-value="否"></el-switch>
        </el-form-item>
        ...
        <el-table :data="[addClothesForm]" stripe style="width: 100%" size="mini">
          ...
          <el-table-column prop="clothingColor" label="衣服颜色" min-width="120px"></el-table-column>
          <el-table-column prop="clothingAccessories" label="衣服附件" min-width="150px"></el-table-column>
          <el-table-column prop="clothingBlemishes" label="衣服瑕疵" min-width="150px"></el-table-column>
          ...
          <el-table-column prop="maLingAmount" label="抹零金额"></el-table-column>
      ...
      <div class="button">
        ...
        <el-button
          type="primary"
          round
          @click.native.stop="handleAddClothes"
          :loading="loading2"
        >{{ btnText2 }}</el-button>
      </div>
    </el-form>
...
export default {
      ...
      this.$refs.addClothesForm.validate(valid => {
        if (valid) {
          if (this.addClothesForm.vipID == "") {
            ...
            axios
              .post(
                "http://127.0.0.1:3000/collectionClothings/addClothes",
                this.addClothesForm
              )
              .then(res => {
                if (res.data == false) {
  ...
  watch: {
    vipIschoose: function() {
      this.vipInfo = this.$store.state.user.chooseVip;
    ...
    payInput: function() {
      ...
      if (this.payInput == false) {
        ...
        this.addClothesForm.paymentMethod = "微信";
      }
    },
